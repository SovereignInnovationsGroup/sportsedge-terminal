...
function normalizeEventName(value: string) {
  return value
    ...
    .replace(/\bmjaellby\b/g, "mjallby")
    .replace(/\bvasteraas\b/g, "vasteras")
    .replace(/\bafc\b|\bfc\b|\bcf\b|\bsc\b|\bif\b|\bifk\b|\baif\b|\bbk\b|\bfk\b|\bik\b|\bsk\b|\bunited\b|\butd\b|\bhotspur\b|\bwanderers\b|\bcounty\b|\balbion\b|\bhove\b/g, " ")
